...
お客様より、リソース管理の都合上、既存の仮想マシンのリソース名を変更したいというお問い合わせをいただくことがございます。
...
> Azure Portal から操作を行いたい場合には、仮想マシン作成後に NIC の付け替えを実施いただく必要がございます。
...
> Linux 仮想マシンの場合、設定ファイル内に MAC アドレスが含まれる可能性がございますので、ご注意いただけますと幸いです。
> 　
...
3. 先ほど控えた内容をもとに、仮想マシンを作成します。
   ...
   - **[基本] タブ**：
     ...
     > 　
     > 可用性ゾーンをご指定いただく場合、ディスクで指定いただいているゾーンと同じゾーンを指定する必要がございますのでご注意ください。
