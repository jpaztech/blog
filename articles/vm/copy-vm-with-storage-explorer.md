...
そのため、VM 停止時間を最小に抑えたい場合は、
 ...
 - 転送用ディスクを転送する
   
といった手順をとることで、VM 停止時間を最小に抑えることが可能です。  
この場合は以下の図解のような流れとなります。  

![](./copy-vm-with-storage-explorer/image1.png) 

それでは、実際の手順を説明させていただきます。
