...
私たちは、Azure をご利用いただいているお客様に、Azure を正常かつ快適にご利用するためのご支援をさしあげています。
この度、Azure サポートを効果的に利用する方法について知りたいというご要望を頂戴したので、サポートへのお問い合わせ方法をご案内させていただきます。

<!-- more -->

本資料は以下のようなお客様にお読みいただくことを想定しています。
...
なお、以下に記載しました内容はあくまで「一般的なお問合せの流れ」をご紹介しています。
...
- この画面にて、自動的に、今回の画面を開いているユーザーアカウント (Azure Portal の右上に表示) がお問い合わせ可能なサブスクリプションが検索され、選択可能となります。
  サポート リクエストでは、ご利用されている環境のヒアリングをしており、サポートからの情報の提示を行う場合があります。お問い合わせされる際には、本アカウントが、対象サブスクリプションの所有者・共同作成者・サービス リクエスト共同作成者のいずれかのセキュリティ ロールが付与されている必要があり、これによってお客様の環境について情報を漏洩していないことを確認しています。
- 有償サポート契約との紐付きはサブスクリプション単位で行っています。このため、適切なサポート レベルにてサービス提供が受けられます。

> [!WARNING]
> **注意: 異なるサブスクリプション上のリソースの調査について**
...
サービスとは、Azure におけるそれぞれのサービス名のことです。できる限り正確に、どのサービスに対してのお問い合わせであるか選択していただくようお願いします。
...
- 詳細なエラー メッセージ。ログファイルや画面ショットなどが準備できる場合、アップロードしていただくことも可能です。
...
> [!TIP]
> **Tips: 対応中の案件の緊急度 を A (24x7 対応) に上昇させたい場合**
...
各サポート リクエストでのサポート エンジニアによる対応品質をお客様にご評価いただき、サポート対応の品質向上を目的としています。
次回以降にお問い合わせいただいた際に、よりお客様にご満足いただける対応を行うため、貴重なご意見として承りますので是非アンケートへの回答にご協力いただけると幸いです。

- アンケートは 5 段階で評価いただけます。
- サポート リクエストごとの送信となり、対応をしたサポート エンジニア個人とチームの今後の方針として活用しております。
  並行して複数のお問い合わせいただいている場合には、できるかぎり記載のお問い合わせ番号の対応に関連したフィードバックをいただけると幸いです。
- 評価の数字 (星 5 ~ 星1) の数が大きいほど、エンジニアのサポート対応にご満足いただいたことを意味します。
  サポート対応にご満足いただいた場合には 星 5 を、改善点があると感じられた場合には、その内容に応じてご評価ください。
- 頂戴した評価についてより詳細なご意見を伺うために、弊社サポート チームよりご連絡させていただく場合がございます。
  今後のサポート対応でお客様によりご満足いただきたく、お客様からのご意見を真摯に受け止めサポート品質向上に努めてまいりますので、ご理解およびご協力の程、何卒よろしくお願い申し上げます。

最後に、お客様から良いご評価をいただけた際にはエンジニアにとっても大変励みになっております。
改善点を頂戴したら全力で改善に努めさせていただきます。
お手数おかけしますが、改めましてアンケートへのご協力をお願いいたします。
