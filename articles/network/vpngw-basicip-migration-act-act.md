...
![](vpngw-basicip-migration-act-act/prepare1-1.png)
...
![](vpngw-basicip-migration-act-act/prepare1-4.png)
 
![](vpngw-basicip-migration-act-act/prepare1-5.png)
 
上記画面の [最新の情報に更新] をクリックして 「更新中」 が消えていることを確認します。

![](vpngw-basicip-migration-act-act/prepare1-6.jpg)

「更新中」 が消えたら [構成] から [Migrate to Standard IP] をクリックして移行画面へ移動します。

![](vpngw-basicip-migration-act-act/prepare1-7.png)
 
準備が完了すると、次のステップである［Migrate］および［Abort］が表示されます。

![](vpngw-basicip-migration-act-act/prepare1-8.png)
...
![](vpngw-basicip-migration-act-act/prepare1-9.png)
...
![](vpngw-basicip-migration-act-act/migrate2-1.png)
...
![](vpngw-basicip-migration-act-act/migrate2-2.png)
