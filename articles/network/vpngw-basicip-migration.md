...
![basic-or-standard-ip](./basic-or-standard.png)
...
![migration-to-standardIP](./migration-to-standardIP.png)
...
![migration-to-standardIP-2](./migration-to-standardIP-2.png)

準備が完了すると、次のステップである［Migrate］および［Abort］が表示されます。<BR>

![migrate-abort](./migrate-abort.png)
