...
Tracking ID: 5RWW-K4G の通知に関するアナウンスの補足
---
title: Tracking ID: 5RWW-K4G の通知に関するアナウンスの補足
...
※ NVA に該当しない VM については、以下ドキュメントの「MANA のサポートの状態を確認する」セクションに沿って、使用している Linux OS が MANA 対応であることを確認の上、必要に応じてカーネルの更新対応をお願いいたします。
